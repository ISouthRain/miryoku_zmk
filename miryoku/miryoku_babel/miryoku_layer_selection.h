...
#if !defined(MIRYOKU_LAYER_APPGAME)
  #define MIRYOKU_LAYER_APPGAME MIRYOKU_ALTERNATIVES_APPGAME
#endif
#if !defined(MIRYOKU_LAYERMAPPING_APPGAME)
  #define MIRYOKU_LAYERMAPPING_APPGAME MIRYOKU_MAPPING
#endif
