...
&kp F12,           &kp F7,            &kp F8,            &kp F9,            &kp PSCRN,         U_LT(U_APPAD, DEL),              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
...
&kp INS,            &kp FSLH,           &kp UP,               &kp ASTERISK,            &kp MINUS,   U_NA,   &kp KP_NUMBER_7,      &kp KP_NUMBER_8,     &kp KP_NUMBER_9,        &kp NON_US_BACKSLASH,            \
